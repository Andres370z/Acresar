...
@Component({
  selector: 'app-modificar-facultativos',
  templateUrl: './modificar-facultativos.component.html',
  styleUrls: ['./modificar-facultativos.component.css']
})
export class ModificarFacultativosComponent implements OnInit {

  modulo = 'Modificar Prima Facultativos';
  money: any;
  mon: any;
  sucursales: any;
  compania: any;
  ...
  createnomina() {
    if (this.cuotaParteFormreasegurador.controls.codigo.value === undefined || this.cuotaParteFormreasegurador.controls.codigo.value === '') {
      this.alerthService.info('Ok','Campo del codigo es obligatorio');
    }
    // tslint:disable-next-line:one-line
      ...
      this.alerthService.info('Ok','Campo ramos es obligatorio');
    }
    // tslint:disable-next-line:one-line
      ...
      this.alerthService.info('Ok','Campo suma limite es obligatorio');
    }
    // tslint:disable-next-line:one-line
      ...
      this.alerthService.info('Ok','Campo total primas es obligatorio');
    }
  ...
  procesar() {
    console.log('-----------> selectcontra', this.selectcontrato);
    ...
    //   this.alerthService.info('Ok','Campo ramos es obligatorio'); LLEGA NULL
    // }
    // tslint:disable-next-line:one-line
    ...
    // tslint:disable-next-line:one-line
      ...
      this.http.putAseUpdate(idpoli, data).then(
        res => {
          ...
          console.log(res);
          this.alerthService.messagefin();
          this.alerthService.info('Ok','Esta poliza asignada');
        },
        err => {
          console.log(err);
          this.alerthService.messagefin();
  ...
  guardarpoliza() {
    ...
    if (this.listasegurado == undefined) {
      this.alerthService.info('Hey','Quieres salir sin agregar tu poliza a un contrato');
    } else {
  ...
  eliminarramos(res: any) {
    ...
    this.http.putFacul(res, data)
      .then(
        res => {
          this.loadramos()
          this.alerthService.success('Ok',"Ramo Eliminado correctamente");
        },
        err => {
          console.log(err);
        }
