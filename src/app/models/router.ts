...
export const RoutersLink = {
    ...
    benefits:"benefits",
    scale:"scale",
    massiveContractAssociation:"massiveContractAssociation",
    ...
    getDtaCuotaAparte: 'contratos/automaticos/proporcionales/cuotaparte',
    ...
    renewContract: 'contratos/prorroga/',
    ...
    getAutomaticoComision: 'automaticos/contrato/count/comision/',
    postForm: 'create/provedoradministracion',
    postContratoFinal: 'contratos/search/final',
    ...
    postFacultativoRamo: 'aseguradoras/facultativo/ramos',
    ...
    postFacultaProcesoNomina: 'aseguradoras/facultativo/procesonomina',
    putFacul: 'aseguradoras/facultativo/ramos/eliminar',
    putFaculUpdate: 'aseguradoras/facultativo/ramos/update',
    postValid: 'contratos/automaticos/poliza/get/valid',
    postBuscarAse: 'buscarasegurador',
    postAseGetAse: 'aseguradoras/automatico/getasegurado',
    postAseProcesp: 'aseguradoras/automatico/proceso',
    postAsegetNomi: 'aseguradoras/automatico/getaseguradonomina',
    postAseNomina: 'aseguradoras/automatico/procesonomina',
    ...
    postContratoCuotaAparteMasivo: 'contratos/automaticos/proporcionales/cuotaparte/contrato/masivo',
    postNominaMasivo:'contratos/automaticos/proporcionales/cuotaparte/contrato/masivo/nomina',
    ...
    postFaculProce: 'aseguradoras/facultativo/proceso',
    postContratosGet: 'contratos/automaticos/poliza/get',
    ...
    postContraPoliza: 'contratos/automaticos/poliza',
    postContratoid: 'contratos/facultativo/contratoid',
    postAseNominaFul: 'aseguradoras/facultativo/procesonomina',
    postAseNominas: 'aseguradoras/facultativo/proceso/siniestro/getaseguradonomina',
    postAseSini: 'aseguradoras/facultativo/getsiniestro',
    postAseSinistro: 'aseguradoras/facultativo/proceso/siniestro',
    postSinistroRamo: 'aseguradoras/facultativo/proceso/siniestro/ramos',
    postAseprocesoNomina: 'aseguradoras/facultativo/proceso/siniestro/procesonomina',
    menuList:"menuList",
    getMenu:"menu",
    editList:"editList",
    ...
    putAse: 'aseguradoras/',
    putAseUpdate: 'aseguradoras/facultativo/proceso/update',
    putUpdatepoliza: 'aseguradoras/facultativo/ramos/updatepoliza',
    postAseProceUpdate: 'aseguradoras/facultativo/procesonomina/update',
    deleteAseReporte: 'aseguradoras/facultativo/proceso/siniestro/reportenomina/eliminar'
...
export const Menssage = {
    ...
    nameEvents:"REPORTE-CONTRATOS",
    nameEventsAsosiation:"REPORTE-ASOCIACION-CONTRATOS",
